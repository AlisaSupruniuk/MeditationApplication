...
import by.supruniuk.alisa.meditationapplication.databinding.ActivityBreathBinding
...
class BreathActivity : AppCompatActivity() {
    ...
    override fun onStop() {
        ...
        sharedPref.updateBreatheMin((3L - minutes).toInt())
        sharedPref.updateBreatheCount()
        timer.cancel()
    }
}